...
// Sun Mar 21 13:27:02 2021 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file: /eos/project/c/collider-fcc-hl-lhc/public/hepmc_files/VBF/background/background.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4030;
   static constexpr Int_t kMaxTrack = 166;
   static constexpr Int_t kMaxTower = 302;
   static constexpr Int_t kMaxEFlowTrack = 166;
   static constexpr Int_t kMaxEFlowPhoton = 112;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/project/c/collider-fcc-hl-lhc/public/hepmc_files/VBF/background/background.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/project/c/collider-fcc-hl-lhc/public/hepmc_files/VBF/background/background.root");
      }
