...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTrack = 200;
   static constexpr Int_t kMaxTower = 500;
   static constexpr Int_t kMaxEFlowTrack = 200;
   static constexpr Int_t kMaxEFlowPhoton = 200;
   static constexpr Int_t kMaxEFlowNeutralHadron = 300;
   ...
   static constexpr Int_t kMaxFatJet = 100;
   ...
   virtual int      selTracks(int jet1Ind, int jet2Ind, double &sumTrkPt,map<string, TH1F*> hmap );
